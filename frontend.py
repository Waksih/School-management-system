...
with st.form(key='fee_form'):
    ...
    submit_button = st.form_submit_button(label='Add Fee Record')
...
with st.form(key='expenditure_form'):
    ...
    submit_button = st.form_submit_button(label='Add Expenditure')
...
with st.form(key='student_activity_form'):
    ...
    submit_button = st.form_submit_button(label='Add Student Activity')
...
with st.form(key='participation_form'):
    ...
    submit_button = st.form_submit_button(label='Add Participation Record')
